...
public class CompanyDaoTestSuite {
    ...
    void testFindEmployeeByLastname() {
        ...
        //Then
        List<Employee> employeeList = employeeDao.findEmployeeByLastname("Clarckson");
    ...
    void testRetrieveCompanyNameByFirstThreeCharacters() {
        ...
        //Then
        List<Company> companyList = companyDao.retrieveCompanyNameByFirstThreeCharacters("Nam");
